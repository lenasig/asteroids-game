 ...
 * animation (or game!) that contains multiple animated objects. The demo shows
 * how collision detection works.
 * 
 * @author Lena, Urvi, Tishya, Aarushi
 *
 */
public class GameDemo extends AbstractAnimation implements KeyListener {
    ...
    /* Flag to control whether more asteroids must be created. */
    ...
    protected void nextFrame() {
        if (moving) {
            ...
            if (checkCollision()) { // ends the game
                score.gameOver();
                moving = false;
                Sound.setGameOver();
            }
