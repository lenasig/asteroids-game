...
/**
 * 
 * Keeps track of all bullets currently in play.
 * 
 * @author Lena
 *
 */
public class ShotsFired {
    ...
    /**
     * Adds the Bullet at the specified index to deadShots to later be removed.
     * 
    ...
    /**
     * Removes the Bullets at each index in deadShots from shots.
     **/
